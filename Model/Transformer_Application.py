...
from networks.subnet.CEmodule import MCFNet
from pytorch_transformers import BertConfig, RobertaConfig
...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, position_ids=None, pos_tag_ids=None, senti_word_ids=None,
                polarity_ids=None):
...
class BertEncoder(nn.Module):
    ...
    def forward(self, hidden_states, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None,
        ...
        # Output of MCFNet
        hidden_states = self.MCFNet(hidden_states, visual=visual, acoustic=acoustic, visual_ids=visual_ids,
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, pos_tag_embedding=False, senti_embedding=False, polarity_embedding=False):
        ...
        self.embeddings = BertEmbeddings(config, pos_tag_embedding=pos_tag_embedding, senti_embedding=senti_embedding,
    ...
    def forward(self, input_ids, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None, pos_ids=None,
                senti_word_ids=None, polarity_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
                head_mask=None):
...
class BertForMultipleChoice(BertPreTrainedModel):
    ...
    def forward(self, input_ids, pos_tag_ids, senti_word_ids, polarity_ids, attention_mask=None, token_type_ids=None,
        ...
        pos_tag_ids = pos_tag_ids.view(-1, pos_tag_ids.size(-1))
        senti_word_ids = senti_word_ids.view(-1, senti_word_ids.size(-1))
        polarity_ids = polarity_ids.view(-1, polarity_ids.size(-1))
